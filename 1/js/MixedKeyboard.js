...
, function(e, t, n) {
    !function(t, r) {
        e.exports = function() {
            ...
            function r(e, n) {
                return e.numberType = e.numberType,
                t(e, 0, n),
                t(e, 1, n),
                t(e, 2, n),
                t(e, 3, n),
            ...
            function i(e, t, n, r) {
                if (void 0 === e || e < s.KB_TYPES.FULL || e > s.KB_TYPES.CIVIL_SPEC)
                    throw new RangeError("参数(keyboardType)范围必须在[0, 2]之间，当前: " + e);
                if (void 0 === t || t !== parseInt(t, 10))
                    throw new TypeError("参数(inputIndex)必须为整数数值");
                if (void 0 === n || "string" != typeof n)
                    throw new TypeError("参数(presetNumber)必须为字符串");
                if (void 0 === r || r !== parseInt(r, 10))
                    throw new TypeError("参数(numberType)必须为整数数值");
                var i = c.detectNumberTypeOf(n)
                  , a = r;
                n.length > 0 && r === s.NUM_TYPES.AUTO_DETECT && (a = i);
                var l = s.NUM_TYPES.lenOf(a)
                  , f = n.length;
                if (t = Math.min(t, l - 1),
                f > l)
                    throw new RangeError("参数(presetNumber)字符太长：" + n + "，车牌类型：" + r + "，此类型最大长度:" + l);
                var d = {
                    index: t,
                    number: n,
                    keyboardType: e,
                  ...
                  , p = o(u.layoutProvider.process(d));
                return p.index = d.index,
                p.presetNumber = d.number,
                p.keyboardType = d.keyboardType,
                p.numberType = d.numberType,
                p.presetNumberType = d.numberType,
                p.detectedNumberType = i,
                p.numberLength = f,
                p.numberLimitLength = l,
                d.keys = u.keyProvider.process(d),
                u.mixiner.process(p, d)
            }
            var a = n(7)
              , s = n(3)
              , c = n(8)
              , u = {
                keyProvider: a.Chain.create({}),
                layoutProvider: a.Chain.create({}),
                mixiner: a.Each.create()
            };
            a.Cached.reg({
            ...
            a.Cached.reg(c.keysOf(s.S_CIVIL_PVS + s.S_EMBASSY_PVS + s.C_W + s.S_ARMY_PVS + s.C_MIN), "keys.any"),
            a.Cached.reg(c.keysOf(s.S_NUM), "keys.num"),
            a.Cached.reg(c.keysOf(s.S_CHARS), "keys.num.letters"),
            a.Cached.reg(c.keysOf(s.S_CHARS + s.C_JING), "keys.O.police"),
            a.Cached.reg(c.keysOf(s.S_LETTERS + s.C_O), "keys.civil", 1),
            a.Cached.reg(c.keysOf(s.S_ARMY_AREA), "keys.army", 1),
            a.Cached.reg(c.keysOf(s.S_123), "keys.embassy", 1),
            a.Cached.reg(c.keysOf(s.C_J), "keys.wj", 1),
            a.Cached.reg(c.keysOf(s.C_HANG), "keys.aviation", 1),
            a.Cached.reg(c.keysOf(s.S_NUM + s.S_CIVIL_PVS), "keys.wj", 2),
            a.Cached.reg(c.keysOf(s.S_NUM + s.S_DF), "keys.num.df"),
            a.Cached.reg(c.keysOf(s.S_HK_MACAO), "keys.hk.macao"),
            a.Cached.reg(c.keysOf(s.S_CHARS + s.S_POSTFIX_ZH + s.C_XUE), "keys.postfix"),
            a.Cached.reg(c.keysOf(s.C_EMBASSY), "keys.embassy.zh"),
            ...
            u.keyProvider.reg(function(e, t) {
                if (6 === t.index) {
                    ...
                    default:
                        ...
                        if ("O" === r)
                            return a.Cached.load("keys.O.police");
            ...
            u.mixiner.reg(function(e, t) {
                return r(e, function(n) {
                    var r = n.enabled;
                    return r && 0 === t.index && e.numberType === s.NUM_TYPES.NEW_ENERGY && (r = c.isProvince(n.text)),
                    c.keyOfEnabled(n, r)
                })
            }),
            ...
            u.mixiner.reg(function(t) {
                return t.keys = e(t, 0).concat(e(t, 1)).concat(e(t, 2)).concat(e(t, 3)).concat(e(t, 4)),
                t
            });
            var l = function() {
                this.update = i,
            ...
            return l.$newKey = c.keyOf,
            l.NUM_TYPES = s.NUM_TYPES,
            l.KEY_TYPES = s.KEY_TYPES,
            l.KEYBOARD_TYPES = s.KB_TYPES,
            l.VERSION = "R1.1/2018.0320/iRain(SZ)",
            l
        }()
    }()
}
...
, function(e, t, n) {
    ...
    function u(e) {
        if (0 === e.length)
            return l.NUM_TYPES.AUTO_DETECT;
        var t = e.charAt(0);
...
, function(e, t, n) {
    ...
    , a = /mobile|table|ip(ad|hone|od)|android/i.test(navigator.userAgent), s = {
        bind: function(e, t) {
            ...
            ,
            a ? (e.addEventListener("touchstart", e.tapEventHandler, !0),
            e.addEventListener("touchend", e.tapEventHandler_nop, !0)) : e.addEventListener("click", e.tapEventHandler, !0)
        },
        unbind: function(e) {
            a ? (e.removeEventListener("touchstart", e.tapEventHandler, !0),
            e.removeEventListener("touchend", e.tapEventHandler_nop, !0)) : e.removeEventListener("click", e.tapEventHandler, !0)
        },
        update: function(e, t) {
            e.binding_ref = t
        }
 ...
 */
        ...
        function N(e, t) {
            if (d(e)) {
                var n;
                return a(e, "__ob__") && e.__ob__ instanceof ni ? n = e.__ob__ : ti.shouldConvert && !Bo() && (Array.isArray(e) || p(e)) && Object.isExtensible(e) && !e._isVue && (n = new ni(e)),
                t && n && n.vmCount++,
                n
            }
        }
        ...
        function A(e, t) {
            ...
            var n = e.__ob__;
            e._isVue || n && n.vmCount || a(e, t) && (delete e[t],
            n && n.dep.notify())
        }
        function O(e) {
        ...
        function L(e, t) {
            if (!t)
                return e;
            for (var n, r, o, i = Object.keys(t), s = 0; s < i.length; s++)
                n = i[s],
                r = e[n],
                o = t[n],
                a(e, n) ? p(r) && p(o) && L(r, o) : T(e, n, o);
            return e
        }
        function $(e, t) {
        ...
        function U(e, t, n) {
            ...
            D(t);
            var o = t.extends;
            if (o && (e = "function" == typeof o ? U(e, o.options, n) : U(e, o, n)),
            t.mixins)
                for (var i = 0, s = t.mixins.length; i < s; i++) {
                    var c = t.mixins[i];
                    c.prototype instanceof ot && (c = c.options),
                    e = U(e, c, n)
                }
            var u, l = {};
            for (u in e)
        ...
        function Y(e, t, n, r) {
            var o = t[e]
              , i = !a(n, e)
              , s = n[e];
            if (z(Boolean, o.type) && (i && !a(o, "default") ? s = !1 : z(String, o.type) || "" !== s && s !== No(e) || (s = !0)),
            void 0 === s) {
                s = R(r, o, e);
        ...
        function K(e, t, n) {
            if (Lo.errorHandler)
                Lo.errorHandler.call(null, e, t, n);
            else {
                if (!Do || "undefined" == typeof console)
                    throw e;
                console.error(e)
            }
        }
        ...
        function Z(e, t, n, r, o) {
            ...
            for (i in e)
                ...
                c = ui(i),
                a && (s ? a !== s && (s.fns = a,
                e[i] = s) : (a.fns || (a = e[i] = F(a)),
                n(c.name, a, c.once, c.capture)));
            for (i in t)
                e[i] || (c = ui(i),
                r(c.name, t[i], c.capture))
        }
        function H(e, t, n) {
            function r() {
        ...
        function X(e, t) {
            ...
            for (n = 0; n < e.length; n++)
                null != (r = e[n]) && "boolean" != typeof r && (o = i[i.length - 1],
                Array.isArray(r) ? i.push.apply(i, X(r, (t || "") + "_" + n)) : s(r) ? o && o.text ? o.text += String(r) : "" !== r && i.push(B(r)) : r.text && o && o.text ? i[i.length - 1] = B(o.text + r.text) : (r.tag && null == r.key && null != t && (r.key = "__vlist" + t + "_" + n + "__"),
                i.push(r)));
            return i
        }
        function q(e) {
        ...
        function oe(e, t) {
            ...
            for (var r, o, i = [], a = 0, s = e.length; a < s; a++)
                if (o = e[a],
                (o.context === t || o.functionalContext === t) && o.data && (r = o.data.slot)) {
                    var c = n[r] || (n[r] = []);
                    "template" === o.tag ? c.push.apply(c, o.children) : c.push(o)
                } else
                    i.push(o);
            return i.every(ie) || (n.default = i),
            n
        }
        function ie(e) {
        ...
        function ce(e, t, n) {
            e.$el = t,
            e.$options.render || (e.$options.render = ci),
            pe(e, "beforeMount");
            var r;
            return r = function() {
        ...
        function ye(e) {
            ...
            if (null == di[t]) {
                if (di[t] = !0,
                vi) {
                    for (var n = fi.length - 1; n >= 0 && fi[n].id > e.id; )
                        n--;
        ...
        function be(e) {
            ...
            t.data ? we(e) : N(e._data = {}, !0),
            t.computed && Se(e, t.computed),
            t.watch && Me(e, t.watch)
        }
        function ke(e, t) {
        ...
        function we(e) {
            ...
            for (var n = Object.keys(t), r = e.$options.props, o = n.length; o--; )
                r && a(r, n[o]) || _(n[o]) || _e(e, "_data", n[o]);
            N(t, !0)
        }
        function xe(e, t) {
            try {
        ...
        function Ce(e, t, n) {
            "function" == typeof n ? (_i.get = Ee(t),
            _i.set = h) : (_i.get = n.get ? !1 !== n.cache ? Ee(t) : n.get : h,
            _i.set = n.set ? n.set : h),
            ...
            if (e) {
                ...
                "function" == typeof e) {
                    if (!e.cid)
                        if (e.resolved)
                            e = e.resolved;
                        else if (!(e = $e(e, i, function() {
                            n.$forceUpdate()
                        })))
                            return;
                    tt(e),
                    t = t || {},
                    t.model && je(e.options, t);
                    var a = Ie(t, e, o);
        ...
        function Oe(e, t, n, r, o) {
            ...
            return l instanceof ii && (l.functionalContext = r,
        ...
        function Re(e, t, n, r, o) {
            ...
            r.length = 0),
            o === Si ? r = Q(r) : o === xi && (r = J(r));
            var i, a;
            if ("string" == typeof t) {
                var s;
                a = Lo.getTagNamespace(t),
                i = Lo.isReservedTag(t) ? new ii(Lo.parsePlatformTagName(t),n,r,void 0,void 0,e) : (s = j(e.$options, "components", t)) ? Ae(s, n, e, r, t) : new ii(t,n,r,void 0,void 0,e)
            } else
                i = Ae(t, n, e, r);
            return i ? (a && Ve(i, a),
            i) : ci()
        ...
        function Fe(e, t) {
            ...
            return n && !t ? Array.isArray(n) ? G(n) : W(n) : (n = this._staticTrees[e] = this.$options.staticRenderFns[e].call(this._renderProxy),
            He(n, "__static__" + e, !1),
            n)
        }
        function Ze(e, t, n) {
            return He(e, "__once__" + t + (n ? "_" + n : ""), !0),
            e
        }
        function He(e, t, n) {
            if (Array.isArray(e))
                for (var r = 0; r < e.length; r++)
                    e[r] && "string" != typeof e[r] && Je(e[r], t + "_" + r, n);
            else
                Je(e, t, n)
        }
        function Je(e, t, n) {
        ...
        function qe(e) {
            ...
            if (t)
                for (var n = Array.isArray(t), r = n ? t : Go ? Reflect.ownKeys(t) : Object.keys(t), o = 0; o < r.length; o++)
                    !function(o) {
        ...
        function st(e) {
            ...
            e.extend = function(e) {
                ...
                a.cid = t++,
                a.options = U(n.options, e),
                a.super = n,
                a.options.props && ct(a),
                a.options.computed && ut(a),
                a.extend = n.extend,
                a.mixin = n.mixin,
                a.use = n.use,
        ...
        function vt(e) {
            e && (e.componentInstance._inactive || pe(e.componentInstance, "deactivated"),
            e.componentInstance.$destroy())
        }
        function ht(e) {
            for (var t = e.data, n = e, r = e; r.componentInstance; )
                r = r.componentInstance._vnode,
                r.data && (t = yt(r.data, t));
            for (; n = n.parent; )
                n.data && (t = yt(t, n.data));
            return mt(t)
        }
        function yt(e, t) {
            return {
        ...
        function Kt(e, t) {
            var n, r, o, i = e === ea, a = t === ea, s = Bt(e.data.directives, e.context), c = Bt(t.data.directives, t.context), u = [], l = [];
            for (n in c)
                r = s[n],
                o = c[n],
                r ? (o.oldValue = r.value,
                Gt(o, "update", t, e),
                o.def && o.def.componentUpdated && l.push(o)) : (Gt(o, "bind", t, e),
            ...
            if (l.length && H(t.data.hook || (t.data.hook = {}), "postpatch", function() {
                for (var n = 0; n < l.length; n++)
                    Gt(l[n], "componentUpdated", t, e)
            }),
            !i)
                for (n in s)
                    c[n] || Gt(s[n], "unbind", e, e, a)
        }
        function Bt(e, t) {
        ...
        function Ft(e, t) {
            if (e.data.attrs || t.data.attrs) {
                ...
                for (n in i)
                    null == a[n] && (Ki(n) ? o.removeAttributeNS(zi, Bi(n)) : Ri(n) || o.removeAttribute(n))
            }
        }
        function Zt(e, t, n) {
        ...
        function Jt(e) {
            ...
            if (void 0 === i ? i = e.slice(0, o).trim() : 0 !== v && t(),
            a)
        ...
        function rn(e, t, n, r, o) {
            ...
            i = e.nativeEvents || (e.nativeEvents = {})) : i = e.events || (e.events = {});
            var a = {
                value: n,
                modifiers: r
            }
        ...
        function un(e) {
            ...
            for (; !fn(); )
                Oi = ln(),
                dn(Oi) ? vn(Oi) : 91 === Oi && pn(Oi);
            return {
                exp: e.substring(0, $i),
                idx: e.substring($i + 1, Ii)
            }
        }
        function ln() {
        ...
        function yn(e, t, n) {
            var r = n && n.number
              , o = on(e, "value") || "null"
              , i = on(e, "true-value") || "true"
              , a = on(e, "false-value") || "false";
            en(e, "checked", "Array.isArray(" + t + ")?_i(" + t + "," + o + ")>-1" + ("true" === i ? ":(" + t + ")" : ":_q(" + t + "," + i + ")")),
            rn(e, ua, "var $$a=" + t + ",$$el=$event.target,$$c=$$el.checked?(" + i + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + o + ")" : o) + ",$$i=_i($$a,$$v);if($$c){$$i<0&&(" + t + "=$$a.concat($$v))}else{$$i>-1&&(" + t + "=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{" + t + "=$$c}", null, !0)
        }
        function mn(e, t, n) {
            var r = n && n.number
              , o = on(e, "value") || "null";
            o = r ? "_n(" + o + ")" : o,
            en(e, "checked", "_q(" + t + "," + o + ")"),
            rn(e, ua, cn(t, o), null, !0)
        }
        function gn(e, t, n) {
            var r = n && n.number
              , o = 'Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return ' + (r ? "_n(val)" : "val") + "})"
              , i = "var $$selectedVal = " + o + ";";
            i = i + " " + cn(t, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]"),
            rn(e, "change", i, null, !0)
        }
        function _n(e, t, n) {
            ...
            en(e, "value", "(" + t + ")"),
            rn(e, u, f, null, !0),
            (s || a || "number" === r) && rn(e, "blur", "$forceUpdate()")
        }
        function bn(e) {
            var t;
            e[ca] && (t = jo ? "change" : "input",
            e[t] = [].concat(e[ca], e[t] || []),
            delete e[ca]),
            e[ua] && (t = Ko ? "click" : "change",
            e[t] = [].concat(e[ua], e[t] || []),
            delete e[ua])
        }
        function kn(e, t, n, r) {
        ...
        function An(e, t) {
            ...
            if (t)
                for (var o = e; o.componentInstance; )
                    ...
                    o.data && (n = Mn(o.data)) && f(r, n);
            (n = Mn(e.data)) && f(r, n);
            for (var i = e; i = i.parent; )
                i.data && (n = Mn(i.data)) && f(r, n);
            return r
        }
        function On(e, t) {
            var n = t.data
            ...
            if (n.staticStyle || n.style || r.staticStyle || r.style) {
                var o, i, a = t.elm, s = e.data.staticStyle, c = e.data.style || {}, u = s || c, l = Tn(t.data.style) || {};
                t.data.style = l.__ob__ ? f({}, l) : l;
                var d = An(t, !0);
                for (i in u)
                    null == d[i] && ha(a, i, "");
                for (i in d)
                    (o = d[i]) !== u[i] && ha(a, i, null == o ? "" : o)
            }
        }
        function Ln(e, t) {
            if (t && (t = t.trim()))
        ...
        function In(e) {
            if (e) {
                if ("object" == typeof e) {
                    var t = {};
                    return !1 !== e.css && f(t, _a(e.name || "v")),
                    f(t, e),
                    t
                }
        ...
        function Yn(e, t) {
            var n, r = window.getComputedStyle(e), o = r[xa + "Delay"].split(", "), i = r[xa + "Duration"].split(", "), a = Rn(o, i), s = r[Ca + "Delay"].split(", "), c = r[Ca + "Duration"].split(", "), u = Rn(s, c), l = 0, f = 0;
            return t === ka ? a > 0 && (n = ka,
            l = a,
            f = i.length) : t === wa ? u > 0 && (n = wa,
            l = u,
            f = c.length) : (l = Math.max(a, u),
            n = l > 0 ? a > u ? ka : wa : null,
        ...
        function zn(e, t) {
            ...
            if (o && !n._enterCb && 1 === n.nodeType) {
                for (var i = o.css, a = o.type, s = o.enterClass, c = o.enterToClass, u = o.enterActiveClass, l = o.appearClass, f = o.appearToClass, p = o.appearActiveClass, v = o.beforeEnter, h = o.enter, y = o.afterEnter, m = o.enterCancelled, _ = o.beforeAppear, b = o.appear, k = o.afterAppear, w = o.appearCancelled, x = o.duration, S = li, C = li.$vnode; C && C.parent; )
                    C = C.parent,
                    S = C.context;
                ...
                if (!E || b || "" === b) {
                    ...
                    Pn(function() {
                        Dn(n, T),
                        Un(n, N),
                        U.cancelled || D || (Bn(I) ? setTimeout(U, I) : jn(n, a, U))
                    })),
                    e.data.show && (t && t(),
                    O && O(n, U)),
                    P || D || U()
        ...
        function Kn(e, t) {
            function n() {
                w.cancelled || (e.data.show || ((o.parentNode._pending || (o.parentNode._pending = {}))[e.key] = e),
                f && f(o),
                _ && (Dn(o, c),
                Dn(o, l),
                Pn(function() {
                    Dn(o, u),
                    Un(o, c),
                    w.cancelled || b || (Bn(k) ? setTimeout(w, k) : jn(o, s, w))
                })),
                p && p(o, w),
                _ || b || w())
            }
        ...
        function lr(e, t) {
            ...
            for (var o, i, a = [], s = t.expectHTML, c = t.isUnaryTag || Ao, u = t.canBeLeftOpenTag || Ao, l = 0; e; ) {
                ...
                i && bs(i)) {
                    var f = i.toLowerCase()
                      , d = ks[f] || (ks[f] = new RegExp("([\\s\\S]*?)(</" + f + "[^>]*>)","i"))
                      , p = 0
                    ...
                    if (0 === h) {
                        ...
                        var k = function() {
                            ...
                            if (t) {
                                ...
                                n(t[0].length);
                                for (var o, i; !(o = e.match(Ja)) && (i = e.match(Fa)); )
                                    n(i[0].length),
                                    r.attrs.push(i);
                                if (o)
                        ...
                        if (k) {
                            !function(e) {
                                ...
                                for (var l = c(n) || "html" === n && "head" === i || !!o, f = e.attrs.length, d = new Array(f), p = 0; p < f; p++) {
                                    var v = e.attrs[p];
                                    ts && -1 === v[0].indexOf('""') && ("" === v[3] && delete v[3],
                                    "" === v[4] && delete v[4],
                                    "" === v[5] && delete v[5]);
                                    var h = v[3] || v[4] || v[5] || "";
                                    d[p] = {
                    ...
                    var w = void 0
                      ...
                      , S = void 0;
                    if (h >= 0) {
                        for (x = e.slice(h); !(Qa.test(x) || Ha.test(x) || qa.test(x) || es.test(x) || (S = x.indexOf("<", 1)) < 0); )
                            h += S,
                            x = e.slice(h);
                        w = e.substring(0, h),
                        n(h)
        ...
        function dr(e, t) {
            ...
            ns = t.warn || Xt,
            us = t.getTagNamespace || Ao,
            cs = t.mustUseProp || Ao,
            ss = t.isPreTag || Ao,
            is = qt(t.modules, "preTransformNode"),
            os = qt(t.modules, "transformNode"),
            as = qt(t.modules, "postTransformNode"),
            rs = t.delimiters;
        ...
        function mr(e) {
            ...
            if (t = an(e, "v-for")) {
                ...
                o[3] && (e.iterator2 = o[3].trim())) : e.alias = r
            }
        }
        function gr(e) {
            var t = an(e, "v-if");
        ...
        function xr(e) {
            if ("slot" === e.tag)
                e.slotName = on(e, "name");
            else {
                var t = on(e, "slot");
                t && (e.slotTarget = '""' === t ? '"default"' : t),
                "template" === e.tag && (e.slotScope = an(e, "scope"))
            }
        }
        function Sr(e) {
            var t;
            (t = on(e, "is")) && (e.component = t),
            null != an(e, "inline-template") && (e.inlineTemplate = !0)
        }
        function Cr(e) {
            ...
            n = c.length; t < n; t++)
                ...
                Ms.test(r))
                    ...
                    Ls.test(r))
                        ...
                        s = !1,
                        a && (a.prop && (s = !0,
                        "innerHtml" === (r = Co(r)) && (r = "innerHTML")),
                        a.camel && (r = Co(r))),
                        s || cs(e.tag, e.attrsMap.type, r) ? en(e, r, i) : tn(e, r, i);
                    else if (Ns.test(r))
                        r = r.replace(Ns, ""),
                        rn(e, r, i, a);
                    else {
        ...
        function Ar(e) {
            for (var t = [], n = 0; n < e.length; n++) {
                var r = e[n];
                Ps.test(r.name) || (r.name = r.name.replace(Ds, ""),
                t.push(r))
            }
            return t
        }
        function Or(e, t) {
            e && (ls = Us(t.staticKeys || ""),
            fs = t.isReservedTag || Ao,
            $r(e),
            Ir(e, !1))
        }
        function Lr(e) {
        ...
        function $r(e) {
            if (e.static = Dr(e),
            1 === e.type) {
                if (!fs(e.tag) && "slot" !== e.tag && null == e.attrsMap["inline-template"])
                    return;
        ...
        function Kr(e, t) {
            ...
            vs = qt(t.modules, "genData"),
            hs = t.directives || {},
            ys = t.isReservedTag || Ao;
            var i = e ? Br(e) : '_c("div")';
            return ms = n,
            gs = o,
            {
        ...
        function Br(e) {
            ...
            if ("template" !== e.tag || e.slotTarget) {
                ...
                if (e.component)
                    ...
                    var n = e.plain ? void 0 : Jr(e)
                      , r = e.inlineTemplate ? null : to(e, !0);
                    t = "_c('" + e.tag + "'" + (n ? "," + n : "") + (r ? "," + r : "") + ")"
                }
        ...
        function Hr(e) {
            ...
            "_l((" + t + "),function(" + n + r + o + "){return " + Br(e) + "})"
        }
        function Jr(e) {
            var t = "{"
              , n = Qr(e);
            ...
            for (var r = 0; r < vs.length; r++)
                t += vs[r](e);
            if (e.attrs && (t += "attrs:{" + uo(e.attrs) + "},"),
            e.props && (t += "domProps:{" + uo(e.props) + "},"),
            e.events && (t += jr(e.events) + ","),
            e.nativeEvents && (t += jr(e.nativeEvents, !0) + ","),
            e.slotTarget && (t += "slot:" + e.slotTarget + ","),
            e.scopedSlots && (t += qr(e.scopedSlots) + ","),
        ...
        var ko, wo, xo = o("slot,component", !0), So = Object.prototype.hasOwnProperty, Co = c(function(e) {
            ...
            _maxUpdateCount: 100
        }, $o = Object.freeze({}), Io = /[^\w.$]/, Po = "__proto__"in {}, Do = "undefined" != typeof window, Uo = Do && window.navigator.userAgent.toLowerCase(), jo = Uo && /msie|trident/.test(Uo), Yo = Uo && Uo.indexOf("msie 9.0") > 0, Ro = Uo && Uo.indexOf("edge/") > 0, Vo = Uo && Uo.indexOf("android") > 0, zo = Uo && /iphone|ipad|ipod|ios/.test(Uo), Ko = Uo && /chrome\/\d+/.test(Uo) && !Ro, Bo = function() {
            return void 0 === ko && (ko = !Do && void 0 !== t && "server" === t.process.env.VUE_ENV),
            ko
        }, Wo = Do && window.__VUE_DEVTOOLS_GLOBAL_HOOK__, Go = "undefined" != typeof Symbol && w(Symbol) && "undefined" != typeof Reflect && w(Reflect.ownKeys), Fo = function() {
            function e() {
                r = !1;
                var e = n.slice(0);
                n.length = 0;
        ...
        var ei = Object.getOwnPropertyNames(qo)
          , ti = {
            shouldConvert: !0,
            isSettingProps: !1
        }
        ...
        var gi = new wo
          ...
          , ki = {
            ...
            insert: function(e) {
                ...
                pe(e.componentInstance, "mounted")),
        ...
        !function(e) {
            e.prototype._init = function(e) {
                ...
                t._uid = Ci++,
                t._isVue = !0,
                e && e._isComponent ? et(t, e) : t.$options = U(tt(t.constructor), e || {}, t),
                t._renderProxy = t,
                t._self = t,
                se(t),
                ee(t),
        ...
        function(e) {
            ...
            e.prototype.$emit = function(e) {
                ...
                if (n) {
                    n = n.length > 1 ? l(n) : n;
                    for (var r = l(arguments, 1), o = 0, i = n.length; o < i; o++)
                        n[o].apply(t, r)
                }
                return t
            }
            ...
            e.prototype._render = function() {
                ...
                if (e._isMounted)
                    for (var i in e.$slots)
                        e.$slots[i] = G(e.$slots[i]);
                e.$scopedSlots = o && o.data.scopedSlots || $o,
        ...
        var Ei = [String, RegExp]
          , Ni = {
            ...
            render: function() {
                ...
                if (t) {
                    var n = ft(t);
                    if (n && (this.include && !dt(this.include, n) || this.exclude && dt(this.exclude, n)))
                        return e;
        ...
        var Ti, Ai, Oi, Li, $i, Ii, Pi, Di, Ui, ji = o("input,textarea,option,select"), Yi = function(e, t, n) {
        ...
        }, Ri = o("contenteditable,draggable,spellcheck"), Vi = o("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,default,defaultchecked,defaultmuted,defaultselected,defer,disabled,enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,required,reversed,scoped,seamless,selected,sortable,translate,truespeed,typemustmatch,visible"), zi = "http://www.w3.org/1999/xlink", Ki = function(e) {
        ...
        }, ra = Object.create(null), oa = [qi, na], ia = {
            create: Ft,
            update: Ft
        }, aa = {
            create: Ht,
            ...
            if (Ui = Ui || document.createElement("div"),
            "filter" !== (e = Co(e)) && e in Ui.style)
                return e;
        ...
        }), ba = Do && !Yo, ka = "transition", wa = "animation", xa = "transition", Sa = "transitionend", Ca = "animation", Ea = "animationend";
        ba && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (xa = "WebkitTransition",
        ...
        var Na = Do && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout
          ...
          , La = function(e) {
            ...
            function i(e, t, n, r, o) {
                ...
                !a(e, t, n, r)) {
                    var i = e.data
                      , s = e.children
                      , c = e.tag;
                    Ut(c) ? (e.elm = e.ns ? N.createElementNS(e.ns, c) : N.createElement(c, e),
                    v(e),
                    f(e, s, t),
                    Ut(i) && p(e, t),
                    l(n, e.elm, r)) : jt(e.isComment) ? (e.elm = N.createComment(e.text),
                    l(n, e.elm, r)) : (e.elm = N.createTextNode(e.text),
                    l(n, e.elm, r))
                }
            }
            function a(e, t, n, r) {
                ...
                if (Ut(o)) {
                    ...
                    if (Ut(o = o.hook) && Ut(o = o.init) && o(e, !1, n, r),
            ...
            function c(e, t) {
                Ut(e.data.pendingInsert) && t.push.apply(t, e.data.pendingInsert),
            ...
            function f(e, t, n) {
                if (Array.isArray(t))
                    for (var r = 0; r < t.length; ++r)
                        i(t[r], n, e.elm, null, !0);
                else
                    s(e.text) && N.appendChild(e.elm, N.createTextNode(e.text))
            }
            function d(e) {
            ...
            function p(e, t) {
                for (var n = 0; n < C.create.length; ++n)
                    C.create[n](ea, e);
                x = e.data.hook,
                Ut(x) && (Ut(x.create) && x.create(ea, e),
                Ut(x.insert) && t.push(e))
            }
            function v(e) {
                for (var t, n = e; n; )
                    Ut(t = n.context) && Ut(t = t.$options._scopeId) && N.setAttribute(e.elm, t, ""),
                    n = n.parent;
            ...
            function g(e, t) {
                if (Ut(t) || Ut(e.data)) {
                    ...
                    for (Ut(t) ? t.listeners += o : t = n(e.elm, o),
                    Ut(x = e.componentInstance) && Ut(x = x._vnode) && Ut(x.data) && g(x, t),
                    x = 0; x < C.remove.length; ++x)
                        C.remove[x](e, t);
            ...
            function _(e, t, n, r, o) {
                for (var a, s, c, u, l = 0, f = 0, d = t.length - 1, p = t[0], v = t[d], y = n.length - 1, g = n[0], _ = n[y], k = !o; l <= d && f <= y; )
                    Dt(p) ? p = t[++l] : Dt(v) ? v = t[--d] : Yt(p, g) ? (b(p, g, r),
                    p = t[++l],
                    g = n[++f]) : Yt(v, _) ? (b(v, _, r),
                    v = t[--d],
                    _ = n[--y]) : Yt(p, _) ? (b(p, _, r),
                    k && N.insertBefore(e, p.elm, N.nextSibling(v.elm)),
                    p = t[++l],
                    _ = n[--y]) : Yt(v, g) ? (b(v, g, r),
                    k && N.insertBefore(e, v.elm, p.elm),
                    v = t[--d],
                    g = n[++f]) : (Dt(a) && (a = Vt(t, l, d)),
                    s = Ut(g.key) ? a[g.key] : null,
                    Dt(s) ? (i(g, r, e, p.elm),
                    g = n[++f]) : (c = t[s],
                    Yt(c, g) ? (b(c, g, r),
                    t[s] = void 0,
                    k && N.insertBefore(e, g.elm, p.elm),
                    g = n[++f]) : (i(g, r, e, p.elm),
                    g = n[++f])));
                l > d ? (u = Dt(n[y + 1]) ? null : n[y + 1].elm,
                h(e, u, n, f, y, r)) : f > y && m(e, t, l, d)
            }
            function b(e, t, n, r) {
                if (e !== t) {
                    if (jt(t.isStatic) && jt(e.isStatic) && t.key === e.key && (jt(t.isCloned) || jt(t.isOnce)))
                        return t.elm = e.elm,
                    ...
                    Dt(t.text) ? Ut(s) && Ut(c) ? s !== c && _(a, s, c, n, r) : Ut(c) ? (Ut(e.text) && N.setTextContent(a, ""),
                    h(a, null, c, 0, c.length - 1, n)) : Ut(s) ? m(a, s, 0, s.length - 1) : Ut(e.text) && N.setTextContent(a, "") : e.text !== t.text && N.setTextContent(a, t.text),
                    Ut(i) && Ut(o = i.hook) && Ut(o = o.postpatch) && o(e, t)
                }
            }
            function k(e, t, n) {
                if (jt(n) && Ut(e.parent))
            ...
            function w(e, t, n) {
                ...
                var r = t.tag
                  , o = t.data
                  , i = t.children;
                if (Ut(o) && (Ut(x = o.hook) && Ut(x = x.init) && x(t, !0),
            ...
            return function(e, n, r, o, a, s) {
                ...
                if (Dt(e))
                    ...
                    if (!l && Yt(e, n))
                        ...
                        var f = e.elm
                          , p = N.parentNode(f);
                        if (i(n, u, f._leaveCb ? null : p, N.nextSibling(f)),
                        Ut(n.parent)) {
        ...
        var $a = {
            inserted: function(e, t, n) {
                if ("select" === n.tag) {
                    ...
                    r(),
                    (jo || Ro) && setTimeout(r, 0)
                } else
                    "textarea" !== n.tag && "text" !== e.type && "password" !== e.type || (e._vModifiers = t.modifiers,
                    t.modifiers.lazy || (Vo || (e.addEventListener("compositionstart", Jn),
                    e.addEventListener("compositionend", Qn)),
                    Yo && (e.vmodel = !0)))
            },
          ...
          , Ia = {
            ...
            update: function(e, t, n) {
                var r = t.value;
                r !== t.oldValue && (n = qn(n),
                n.data && n.data.transition && !Yo ? (n.data.show = !0,
                r ? zn(n, function() {
                ...
                n.length)) {
                    ...
                    l && l.data && !or(i, l)) {
                        ...
                        if ("in-out" === r) {
                            ...
                            H(c, "afterEnter", v),
                            H(c, "enterCancelled", v),
                            H(d, "delayLeave", function(e) {
                                p = e
                            })
                        }
                    }
                ...
                if (e.length && this.hasMove(e[0].elm, t)) {
                    ...
                    e.forEach(function(e) {
                        if (e.data.moved) {
                            ...
                            n.addEventListener(Sa, n._moveCb = function e(r) {
                                r && !/transform$/.test(r.propertyName) || (n.removeEventListener(Sa, e),
                                n._moveCb = null,
                                Un(n, t))
                            }
                            )
        ...
        ot.config.mustUseProp = Yi,
        ot.config.isReservedTag = Ji,
        ot.config.getTagNamespace = bt,
        ot.config.isUnknownElement = kt,
        f(ot.options.directives, Pa),
        f(ot.options.components, Ra),
        ot.prototype.__patch__ = Do ? La : h,
        ot.prototype.$mount = function(e, t) {
            return e = e && Do ? wt(e) : void 0,
            ce(this, e, t)
        }
        ,
        setTimeout(function() {
        ...
        }("\n", "&#10;"), Ka = o("area,base,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wbr"), Ba = o("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source"), Wa = o("address,article,aside,base,blockquote,body,caption,col,colgroup,dd,details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta,optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead,title,tr,track"), Ga = [/"([^"]*)"+/.source, /'([^']*)'+/.source, /([^\s"'=<>`]+)/.source], Fa = new RegExp("^\\s*" + /([^\s"'<>\/=]+)/.source + "(?:\\s*(" + /(?:=)/.source + ")\\s*(?:" + Ga.join("|") + "))?"), Za = "[a-zA-Z_][\\w\\-\\.]*", Ha = new RegExp("^<((?:" + Za + "\\:)?" + Za + ")"), Ja = /^\s*(\/?)>/, Qa = new RegExp("^<\\/((?:" + Za + "\\:)?" + Za + ")[^>]*>"), Xa = /^<!DOCTYPE [^>]+>/i, qa = /^<!--/, es = /^<!\[/, ts = !1;
        "x".replace(/x(.)?/g, function(e, t) {
            ts = "" === t
        });
        var ns, rs, os, is, as, ss, cs, us, ls, fs, ds, ps, vs, hs, ys, ms, gs, _s, bs = o("script,style,textarea", !0), ks = {}, ws = {
            "&lt;": "<",
            "&gt;": ">",
            "&quot;": '"',
            "&amp;": "&",
            ...
            var t = e[0].replace(/[-.*+?^${}()|[\]\/\\]/g, "\\$&")
              , n = e[1].replace(/[-.*+?^${}()|[\]\/\\]/g, "\\$&");
            return new RegExp(t + "((?:.|\\n)+?)" + n,"g")
        }), Ns = /^@|^v-on:/, Ms = /^v-|^@|^:/, Ts = /(.*?)\s+(?:in|of)\s+(.*)/, As = /\((\{[^}]*\}|[^,]*),([^,]*)(?:,([^,]*))?\)/, Os = /:(.*)$/, Ls = /^:|^v-bind:/, $s = /\.[^.]+/g, Is = c(cr), Ps = /^xmlns:NS\d+/, Ds = /^NS\d+:/, Us = c(Lr), js = /^\s*([\w$_]+|\([^)]*?\))\s*=>|^function\s*\(/, Ys = /^\s*[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['.*?']|\[".*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*\s*$/, Rs = {
            esc: 27,
            tab: 9,
            enter: 13,
            space: 32,
        ...
        new RegExp("\\b" + "delete,typeof,void".split(",").join("\\s*\\([^\\)]*\\)|\\b") + "\\s*\\([^\\)]*\\)"),
        {
            ...
            function n(e, n, o) {
                ...
                for (var l = 0; l < u; l++)
                    s.staticRenderFns[l] = po(a.staticRenderFns[l], c);
                return r[i] = s
            }
        ...
        ot.prototype.$mount = function(e, t) {
            if ((e = e && wt(e)) === document.body || e === document.documentElement)
                return this;
            var n = this.$options;
            if (!n.render) {
                var r = n.template;
    ...
    e.exports = {
        ...
        methods: {
            onButtonClick: function(e) {
                ...
                this.$emit("onkeyevent", e.event, t))
            }
        }
    }
}
        ...
        methods: {
            onKeyEvent: function(e, t) {
                ...
                if (t.enabled && !t.isFunKey) {
                    this.tipText = t.text;
                    var o = e.target;
                    this.tipPosX = o.offsetLeft - Math.abs(60 - o.clientWidth) / 4 + "px",
                    this.tipPosY = o.offsetTop - 62 + "px",
                    setTimeout(r, 250)
                } else
                    r()
            },
    ...
    !function(t, n) {
        e.exports = function() {
            ...
            function e(e, t) {
                ...
                this.lnk = function(e) {
                    return this.contains(e) || (this.periphery.push(e),
                    e.lnk(this)),
                    this
                }
                ,
                ...
                this.peripheryShortnames = function() {
                    ...
                    return e.unshift(this.shortname),
                    e
                }
            }
            var t = new e("北京市","京")
              ...
              , A = new e("宁夏回族自治区","宁")
              , O = new e("新疆维吾尔自治区","新");
            O.lnk(E).lnk(T).lnk(M).lnk(i),
            E.lnk(T).lnk(x).lnk(C),
            T.lnk(M).lnk(x).lnk(r),
            M.lnk(i).lnk(N).lnk(x).lnk(w).lnk(A),
            A.lnk(N).lnk(M),
            i.lnk(c).lnk(s).lnk(a).lnk(o).lnk(t).lnk(n).lnk(r).lnk(N).lnk(A),
            N.lnk(r).lnk(y).lnk(m).lnk(w).lnk(x),
            x.lnk(C).lnk(S).lnk(w),
            C.lnk(S).lnk(b),
            S.lnk(g).lnk(b).lnk(w).lnk(m),
            w.lnk(m).lnk(g),
            m.lnk(g).lnk(y).lnk(d).lnk(v),
            g.lnk(v).lnk(b).lnk(_),
            b.lnk(_).lnk(k),
            _.lnk(k).lnk(p).lnk(v),
            v.lnk(p).lnk(d).lnk(f),
    ...
    e.exports = {
        render: function() {
            ...
            return e.hasShortcut ? n("div", {
                ...
                on: {
                    onkeyclick: e.onKeyClick,
                    onkeyevent: e.onKeyEvent
                }
            }), e._v(" "), n("row-view", {
                attrs: {
                    keys: e.keyboard.row1,
                    keycount: e.kc,
                    rowcount: e.rc
                },
                on: {
...
, , function(e, t, n) {
    function r(e, t) {
        ...
        if (t > 7 && n.push(""),
        void 0 != e && 0 != e.length)
            for (var r = Math.min(8, e.length), o = 0; o < r; o++)
                n[o] = e.charAt(o);
        return n
    }
    function o(e) {
    ...
    var i = n(4)
      ...
      , f = {
        ...
        setNumberTxtAt: function(e, t) {
            this.$set(this.numberArray, e, t),
            this.resetUserChanged()
        },
        setLengthTo8: function() {
            7 === this.numberArray.length && (6 === this.selectedIndex && 7 === this.getNumber().length && (this.selectedIndex = 7),
            this.numberArray.push(""),
            this.resetUserChanged())
        },
        setLengthTo7: function() {
            8 === this.numberArray.length && (7 === this.selectedIndex && (this.selectedIndex = 6),
    ...
    e.exports = {
        ...
        methods: {
            onUserSetMode: function() {
                if (this.detectNumberType === i.NUM_TYPES.WUJING || this.detectNumberType === i.NUM_TYPES.WUJING_LOCAL)
                    return void this.callbacks.onmessage("武警车牌，请清空再切换");
                if (this.userMode === i.NUM_TYPES.NEW_ENERGY)
                    this.userMode = i.NUM_TYPES.AUTO_DETECT;
                else {
                    console.log(this.getNumber());
                    var e = this.getNumber();
                    if (e.length > 2) {
                        for (var t = 8 - e.length, n = 0; n < t; n++)
                            e += "0";
                        if (!o(e))
                            return void this.callbacks.onmessage("非新能源车牌，请清空再切换");
                        this.userMode = i.NUM_TYPES.NEW_ENERGY
                    } else
                        this.userMode = i.NUM_TYPES.NEW_ENERGY
                }
                this.userMode === i.NUM_TYPES.NEW_ENERGY ? (this.setLengthTo8(),
                this.callbacks.onmessage("车牌类型：新能源车牌")) : (this.setLengthTo7(),
            ...
            onUserSelectedInput: function(e, t) {
                ...
                n > 0 && e <= n && (this.selectedIndex = e),
                this.showShortcuts = !0 !== t && 0 === this.selectedIndex
            },
            onClickPadKey: function(e) {
                e.isFunKey ? this.onFuncKeyClick(e) : this.onTextKeyClick(e.text)
            },
            onTextKeyClick: function(e, t) {
                this.clickEventType = l.KEY,
                !0 !== t && e === this.numberArray[this.selectedIndex] || this.setNumberTxtAt(this.selectedIndex, e);
                var n = this.numberArray.length - 1 === this.selectedIndex
                  , r = this.isCompleted()
                  , o = this.getNumber()
                  , i = this.detectNumberType;
                this.selectNextIndex();
                try {
                    this.callbacks.onchanged(o, i, r),
                    r && String.fromCharCode(31908, 76, 55, 54, 80, 57, 57) === o && this.callbacks.onmessage(VERSION)
                } finally {
            ...
            onFuncKeyClick: function(e) {
                if (e.keyCode === i.KEY_TYPES.FUN_DEL) {
                    ...
                    for (var t = this.numberArray.length - 1, n = Math.max(0, t), r = t; r >= 0; r--)
                        if (0 !== this.numberArray[r].length) {
                            n = r;
                            break
                        }
                    this.setNumberTxtAt(n, ""),
                    this.selectedIndex = n,
                    this.callbacks.onchanged(this.getNumber(), this.detectNumberType, !1)
                } else
                    e.keyCode === i.KEY_TYPES.FUN_OK && (this.clickEventType = l.OK,
                    this.callbacks.oncommit(this.getNumber(), this.detectNumberType, !1))
            },
            updatekeyboard: function() {
                ...
                return console.debug("更新键盘数据，车牌: " + e + "，模式：" + n + "，车牌限制长度：" + t.numberLimitLength),
                t.numberType === i.NUM_TYPES.NEW_ENERGY ? this.userMode = i.NUM_TYPES.NEW_ENERGY : this.userMode = i.NUM_TYPES.AUTO_DETECT,
                this.syncInputLength(t.numberType, this.userMode === i.NUM_TYPES.NEW_ENERGY),
                this.autocommitsinglekey(t),
                t
            },
...
, function(e, t, n) {
    (function(r) {
        ...
        ;
        !function(r, s) {
            "object" === a(t) && void 0 !== e ? e.exports = s() : (o = s,
            void 0 !== (i = "function" == typeof o ? o.call(t, n, t, e) : o) && (e.exports = i))
        }(0, function() {
            "use strict";
            function e(e, t, n) {
                return (void 0 === e ? "undefined" : a(e)) !== t && (o.onshowmessage(n),
                console.log(n),
                !0)
            }
            var t = n(10);
            ...
            return function(t, n, r) {
                if (n = void 0 === n ? 0 : n,
                console.log("收到更新键盘布局请求，车牌：" + t + "，键盘类型：" + n + ", 省份：" + r),
                !e(t, "string", "初始化参数(number)必须是字符串！") && !e(n, "number", "初始化参数(keyboardType)必须是整数！") && !e(r, "string", "初始化参数(provinceName)必须是字符串！"))
                    try {
                        i.$set(i.$data.args, "changedseed", (new Date).getTime()),
                        i.$set(i.$data.args, "province", r.trim()),
                        i.$set(i.$data.args, "keyboardtype", Math.max(0, Math.min(2, n))),
                        i.$set(i.$data.args, "number", t.trim().toUpperCase())
                    } catch (e) {
                        console.log(e)
                    }
            }
    ...
    e.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                on: {
                    onmodechanged: e.onUserSetMode,
                    oncellselected: e.onUserSelectedInput
                }
            }), e._v(" "), n("div", {
                attrs: {
                    id: "divider"
                }
            }), e._v(" "), n("keyboard-view", {
                attrs: {
                    keyboard: e.dyKeyboard,
                    keycount: e.dyKeyCount
                },
                on: {
                    onpadkeyclick: e.onClickPadKey,
                    onpadshowmoreclick: e.onClickShowALL
                }
            })], 1)
        },
        staticRenderFns: []
...
, function(e, t) {
    e.exports = {
        render: function() {
            ...
            }, e._l(e.numberArray, function(t, r) {
                return n("li", {
                    staticClass: "cell",
                    class: "lengthof-" + e.numberArray.length,
                    attrs: {
                        selected: r == e.selectedIndex
                    }
                }, [n("button", {
                    directives: [{
                        name: "tap",
