$(function(){
    ...
    $('#rangePickerConfig input, #rangePickerConfig select').change(function() {
        updateConfig();
    });
    ...
    function updateConfig() {
      ...
      if ($('#applyClass').val().length && $('#applyClass').val() != 'btn-primary')
        options.applyButtonClasses = $('#applyClass').val();

      if ($('#cancelClass').val().length && $('#cancelClass').val() != 'btn-default')
        options.cancelClass = $('#cancelClass').val();

      $('#drpConfigDemo').daterangepicker(options, function(start, end, label) { console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')'); });
      ...
      var replacement = "ranges: {\n"
        ...
        $('#drpConfigText').val("$('#demo').daterangepicker(" + option_text + ", function(start, end, label) {\n  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');\n});");
    }
